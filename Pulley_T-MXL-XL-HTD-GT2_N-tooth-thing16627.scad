// Modified by Wayne Wright, February, 2025 with just one change: module pulley takes the parameter "profile=profile"
...
module pulley( belt_type , pulley_OD , tooth_depth , tooth_width, profile=profile )
	{
